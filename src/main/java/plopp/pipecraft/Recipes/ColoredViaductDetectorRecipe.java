...
public class ColoredViaductDetectorRecipe  extends CustomRecipe {

    public ColoredViaductDetectorRecipe(CraftingBookCategory category) {
        super(category);
    }

    private static final String[] PATTERN = { "ARA", "RVR", "ARA" };
    ...
    public @NotNull RecipeSerializer<?> getSerializer() {
        return ModRecipes.COLORED_VIADUCT_DETECTOR.get();
    }
}