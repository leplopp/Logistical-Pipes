...
public class ColoredViaductConnectorRecipe  extends CustomRecipe {

    public ColoredViaductConnectorRecipe(CraftingBookCategory category) {
        super(category);
    }

    private static final String[] PATTERN = { "IGI", "GAG", "IGI" };
    ...
    public @NotNull RecipeSerializer<?> getSerializer() {
        return ModRecipes.COLORED_VIADUCT_CONNECTOR.get();
    }
}